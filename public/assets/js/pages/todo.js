...
$(document).ready(function() {
    ...
    $("#add-btn").on("click", function() {
        ...
        if (task == "") {
            ...
            var add_todo = $('<div className="to-do-list mb-3" id="' + i + '"><div className="d-inline-block"><label className="check-task custom-control custom-checkbox d-flex justify-content-center"><input type="checkbox" className="custom-control-input" onclick="check_task(' + i + ')" id="checkbox' + i + '"><span className="custom-control-label" for="checkbox' + i + '">' + task + '</span></label></div><div className="float-right"><a onclick="delete_todo(' + i + ');" href="#!" className="delete_todolist"><i className="far fa-trash-alt"></i></a></div></div>');
            i++;
    ...
    $(".btn_save").on("click", function() {
        ...
        if (saveTask == "") {
            ...
            var add_todo = $('<div className="to-do-list mb-3" id="' + i + '"><div className="d-inline-block"><label className="check-task custom-control custom-checkbox d-flex justify-content-center"><input type="checkbox" className="custom-control-input" onclick="check_task(' + i + ')" id="checkbox' + i + '"><span className="custom-control-label" for="checkbox' + i + '">' + saveTask + '</span></label></div><div className="float-right"><a onclick="delete_todo(' + i + ');" href="#!" className="delete_todolist"><i className="far fa-trash-alt"></i></a></div></div>');
            i++;
